...
class TestSentimentAnalyzer(unittest.TestCase):
    ...
    def test_positive_comment_2(self):
        # Positive comment, compound expected > 0
    ...
    def test_positive_comment_3(self):
        # Positive comment, compound expected > 0
    ...
    def test_positive_comment_4(self):
        # Positive comment, compound expected > 0
    ...
    def test_negative_comment_1(self):
