...
NEGATE = \
    ["aint", "arent", "cannot", "cant", "couldnt", "darent", "didnt", "doesnt",
     ...
     "oughtnt", "shant", "shouldnt", "slash", "slashed", "slashes", "uhuh", "wasnt", "werent",
...
BOOSTER_DICT = \
    {"absolutely": B_INCR, "amazingly": B_INCR, "awfully": B_INCR, "beats": B_INCR,
     "completely": B_INCR, "considerable": B_INCR, "considerably": B_INCR,
     "decidedly": B_INCR, "deeply": B_INCR, "definitely": B_INCR, "double-digit": B_INCR, "effing": B_INCR, "enormous": B_INCR,
     "enormously": B_INCR,
...
SPECIAL_CASES = {"the shit": 3, "the bomb": 3, "bad ass": 1.5, "badass": 1.5, "bus stop": 0.0,
                 ...
                 "beating heart": 3.1, "broken heart": -2.9, "never ceases": -2.9 }
